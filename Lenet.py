...
mnist_data_set = input_data.read_data_sets('minst_data',one_hot=True)
...
test_accuracy = accuracy.eval(feed_dict={x:mnist_data_set.test.images,y_:mnist_data_set.test.labels})
